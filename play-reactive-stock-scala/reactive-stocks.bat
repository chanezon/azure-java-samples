@REM reactive-stocks launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM REACTIVE_STOCKS_config.txt found in the REACTIVE_STOCKS_HOME.
@setlocal enabledelayedexpansion
set "JAVA_HOME=d:\home\site\wwwroot\jdk1.8.0"
set "JAVA_OPTS=-Djava.net.preferIPv4Stack=true -Dhttp.port=%HTTP_PLATFORM_PORT% -Dpidfile.path=NUL -Dlogger.file=d:\home\site\wwwroot\logger.xml"

@echo off
if "%REACTIVE_STOCKS_HOME%"=="" set "REACTIVE_STOCKS_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%REACTIVE_STOCKS_HOME%\lib\"
...
set "CFG_FILE=%REACTIVE_STOCKS_HOME%\REACTIVE_STOCKS_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running reactive-stocks.
  echo.
